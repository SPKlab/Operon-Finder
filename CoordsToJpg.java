...
public class CoordsToJpg {
    ...
    public static void saveImage(String oCoordinatesFile, String outputFolder) throws IOException {
        outputFolder += "/";
        ...
        BufferedReader br = new BufferedReader(new FileReader(oCoordinatesFile));
        String line;
        String img_name = "";
        String[] tokens;
        String[] names;
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (names[0].equals("new")) {
                ...
                line = br.readLine();
                if (new File(outputFolder + img_name + ".jpg").exists())
                    continue;
